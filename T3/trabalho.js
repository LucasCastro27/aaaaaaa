...
function loadGLTFFile1(tipo,local)
{
   ...
   if(tipo==1){
    loader.load( './assets/coisas/pedra/scene.gltf', (gltfScene) => {
        ...
        gltfScene.scene.scale.set(2.5,1.8,2.5);
...
function createTile(x, y, z, c, cor) {
    if (c == 0 || c == 2) {
        const textureLoader = new THREE.TextureLoader();
        if(cor==0)
            var wall = textureLoader.load('./assets/textures/wall.jpg');
        else if(cor==1)
            var wall = textureLoader.load('./assets/textures/wallA.jpg');
        else if(cor==2)
            var wall = textureLoader.load('./assets/textures/wallB.jpg');
        else if(cor==3)
            var wall = textureLoader.load('./assets/textures/wallC.jpg');
...
// plataform
colisions.push(createPlane(1,-2,-49.25,25,38.5,'./assets/textures/tile1.jpg'));
...
//=======================================================nivel final===========================================================//
//plataform
colisions.push(createPlane(-35.5,2.01,0,11,11,'./assets/textures/tile2.jpg'));
for (var i = 0; i < 2; i++) {
    for (var j = 0; j < 2; j++) {
